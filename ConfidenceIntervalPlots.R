...
past <- as.array(fit_Calibration_5)
fileName <- "Calibration_6"
...
png(paste("CI_Mm_GFP_Model3_", fileName, "_FitAllCal.png", sep=""), width = 6, height = 4, units = 'in', res = 300)
plot(samplingT, GFPmean, col = "black", pch=20, cex = 0.1, xlab="time (min)", ylab="GFP", 
     main=paste("Results Inference for GFP ", fileName, ", Model 3, fit with all calibration", sep=""), 
...
legend(500, 1400, legend=c("Confidence Interval", "HDI"),
...
png(paste("CI_Mm_RFP_Model3_", fileName, "_FitAllCal.png", sep=""), width = 6, height = 4, units = 'in', res = 300)
plot(samplingT, RFPmean, col = "black", pch=20, cex = 0.1, xlab="time (min)", ylab="RFP", 
     main=paste("Results Inference for RFP ", fileName, ", Model 3, fit with all calibration", sep=""), 
...
legend(200, 4000, legend=c("Confidence Interval", "HDI"),
