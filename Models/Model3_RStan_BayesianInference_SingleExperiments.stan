...
generated quantities{
  ...
  vector[stsl] logLikelihood_RFP;
  vector[stsl] logLikelihood_GFP;
  ...
  for (t in 1:stsl){
    logLikelihood_RFP[t] = normal_lpdf(RFPmean[t]|y_hat[(sts[t]+1),3],RFPstd[t]);
    logLikelihood_GFP[t] = normal_lpdf(GFPmean[t]|y_hat[(sts[t]+1),4],GFPstd[t]);
  }
}
